...
export default function AdminObservabilityPage() {
  ...
  return (
    <main id="observabilidade" className={`min-h-screen scroll-smooth px-4 py-8 transition-all ${authenticated ? (sidebarOpen ? "md:pl-80" : "md:pl-24") : ""}`}>
