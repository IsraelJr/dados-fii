    ...
    return (
        <div className="relative inline-block">
            <button
                ...
                className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-bold ${saved ? "bg-green-500/20 text-green-200" : "bg-indigo-600 text-white hover:bg-indigo-700"}`}
            >
