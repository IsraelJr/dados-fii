...
//                         {(!data.earnings2025 ||
//                             getCurrentYearDividends(data.earnings2025).length === 0) ? (
//                             <p className="bg-gray-800 p-4 rounded-xl text-center text-gray-400">Sem dados para exibir.</p>
//                         ) : (
//                             <ul className="space-y-2">
//                                 {getCurrentYearDividends(data.earnings2025).map(
//                                     ([month, info]: any) => {
...
//                                                 <span>
//                                                     <strong>{monthPT}:</strong> R$ {value.toFixed(3)} | Pago em{" "}
//                                                     {info.payment_date}
//                                                 </span>
//                                             </li>
//                                         );
