...
export const FII_RISK_REPORT_STRUCTURE = [
  ...
  "2. Correlação e concentração: peso por ativo, concentração por segmento, tipo de fundo, gestor, administrador e indexador, quando houver dados.",
  "3. Qualidade dos ativos imobiliários: para fundos de tijolo, avalie vacância, inquilinos, contratos, revisionais, vencimentos e concentração, quando houver dados.",
  "4. Qualidade da carteira de crédito: para papel, CRI, CRA, Fiagro e crédito, avalie devedores, garantias, LTV, subordinação, inadimplência, duration, indexadores e risco de calote, quando houver dados.",
  "5. Sustentabilidade dos dividendos: dividend yield, consistência, recorrência, risco de corte, payout e qualidade da geração de caixa, quando houver dados.",
