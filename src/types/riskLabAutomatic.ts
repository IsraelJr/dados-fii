...
export interface AutomaticMonthlySeries {
  ...
  method: "direct_declared_per_share" | "derived_from_dividend_yield_and_prior_nav" | "mixed" | "unavailable";
  detectorResult: DividendStressWindow | null;
  detectorExecuted: boolean;
  classificationFinal: false;
  limitation: "material_credit_events_not_reviewed" | "insufficient_structured_series";
}
