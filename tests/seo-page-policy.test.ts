...
function qualifiedFund(overrides: Record<string, unknown> = {}): PublicFundData {
  return {
    ...
    pvp: 0.98,
    price: 10.25,
    marketDataUpdatedAt: "2026-08-04T12:00:00Z",
...
test("page policy selects the latest dividend competence and its explicit source", () => {
  ...
  assert.equal(input.dividend?.asOf, "2026-08-14T00:00:00.000Z");
});
